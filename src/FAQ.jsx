      ...
      <Accordion className="accordion">
        ...
        <Accordion.Item eventKey="1" className="accordion-item">
          ...
          <Accordion.Body className="accordion-body">
            ...
            250 to Rs 1,100 a month. No extra costs, no contacts.
          </Accordion.Body>
        </Accordion.Item>
        <Accordion.Item eventKey="2" className="accordion-item">
          ...
          <Accordion.Body className="accordion-body">
            ...
            including smart TVs, smartphones, tablets, streming media players
            and game consoles.
            <br />
            <br />
        ...
        <Accordion.Item eventKey="3" className="accordion-item">
          ...
          <Accordion.Body className="accordion-body">
            ...
            clicks. There are no cancellation fees - start ot stop your account
            anytime.
          </Accordion.Body>
        </Accordion.Item>
        ...
        <Accordion.Item eventKey="5" className="accordion-item">
          ...
          <Accordion.Body className="accordion-body">
            ...
            parents control while kids anjoy family-friendly TV shows and movies
            in their own space.
            <br />
            <br />
